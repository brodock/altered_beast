module ModelStubbing
  define_models do
    ...
    model User do
      stub :username => 'normal-user', :email => 'normal-user@example.com', :state => 'active',
      ...
      stub :activated, :username => 'activated-user', :email => 'activated-user@example.com', :state => 'active',
        :salt => '7e3041ebc2fc05a40c60028e2c4901a81035d3cd', :crypted_password => '00742970dc9e6319f8019fd54864d3ea740f04b1',
  ...
  define_models :users do 
    model User do
      stub :admin,     :username => 'admin-user',     :email => 'admin-user@example.com', :remember_token => 'blah', :admin => true
      stub :pending,   :username => 'pending-user',   :email => 'pending-user@example.com',   :state => 'pending', :activated_at => nil, :remember_token => 'asdf'
      stub :suspended, :username => 'suspended-user', :email => 'suspended-user@example.com', :state => 'suspended', :remember_token => 'dfdfd'
    end
  end

  define_models :moderators do
    model User do
      stub :other, :username => 'other-user', :email => '@example.com'
    end
